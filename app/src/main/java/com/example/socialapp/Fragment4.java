...
public class Fragment4 extends Fragment implements View.OnClickListener {
    ...
    DatabaseReference  likeref, storyRef, likelist, referenceDel, ntref;
    Boolean likechecker = false;
    DatabaseReference db1, db2, db3,checkVideocallRef;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        LinearLayoutManager storylm = new LinearLayoutManager(getActivity(), LinearLayoutManager.HORIZONTAL, false);
        recyclerViewstory.setLayoutManager(storylm);
